...
namespace ENTITY
{
    public abstract class LiquidacionCuotaModeradora
    {
        ...
        {
            return $"{Identificacion};{NumeroLiquidacion};{FechaLiquidacion};{TipoAfiliacion};{SalarioDevengado};{ValorServicioHospitalizacion};{CuotaModeradoraFinal};{CuotaModeradoraReal};{Tarifa};{AplicaTope}";
        }
